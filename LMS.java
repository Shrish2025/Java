...
public class LMS {
    ...
    public static void main(String[] args) {
		...
		case 2:
		    ...
		    System.out.print("Year of Publishing :"); String p = sc.nextLine();
		    System.out.print("Title of book :"); String k = sc.nextLine(); int f = (int)k.charAt(0)-64;
		    int w = k.trim().isEmpty() ? 0 : k.trim().split("\\s+").length;
		    System.out.print("Enter the book edition :"); int bE = sc.nextInt(); sc.nextLine();
		    System.out.print("Item Number :"); int item = sc.nextInt(); sc.nextLine(); 
		    Book myBook = new Book(p, f, w, bE, item);
		    break;
                case 3:
                    System.out.print("Enter Student Reg No: "); String sid = sc.nextLine();
                    LibStudent s = getStudentByID(sid);
                    if (s != null) {
                        System.out.print("Enter Barcode: "); String bc = sc.nextLine();
                        lib.issueBook(bc, s);
                    } else {
                    ...
                    break;
                case 4:
                    System.out.print("Enter Student Reg No: "); String rid = sc.nextLine();
                    LibStudent rs = getStudentByID(rid);
                    if (rs != null) {
                        System.out.print("Enter Barcode: "); String rbc = sc.nextLine();
